export default function FounderPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-b from-bg to-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Early Life & Military Service</h2>
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Competition History</h2>
          <div className="bg-gradient-to-br from-dojo-green/5 to-dojo-navy/5 rounded-2xl p-8 border-l-4 border-dojo-green">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-lg text-gray-700">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>US Air Force USAFE Champion (1957)</span>
              </li>
              <li className="flex items-start gap-3 text-lg text-gray-700">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>Bronze Medal, US Senior Nationals (1963)</span>
              </li>
              <li className="flex items-start gap-3 text-lg text-gray-700">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>US National Masters Champion (1975, 1977, 1980, 1981) – Never lost a match</span>
              </li>
              <li className="flex items-start gap-3 text-lg text-gray-700">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>Two Gold and One Silver Medal, World Master Athlete Games, Ottawa (1998)</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-bg to-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Coaching Excellence</h2>
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <p className="font-semibold text-xl text-dojo-navy">
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Creative Works</h2>
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
            ...
            <div className="bg-gradient-to-br from-dojo-orange/5 to-dojo-red/5 rounded-2xl p-8 border-l-4 border-dojo-orange">
              <h3 className="font-display text-2xl font-bold text-dojo-navy mb-4">Notable Works</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-700">
                  ...
                  <span>"The 65 Throws of Kodokan Judo" (world standard for Judo)</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"The Secrets Of Winning In Judo"</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"The Counters of Judo"</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"Judo Grappling Techniques"</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"Judo From The Beginning"</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"Championship Judo Drill Training" (with Ben Campbell)</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>"The Basic JuJitsu Manual"</span>
                </li>
                <li className="flex items-start gap-3 text-gray-700">
                  <svg className="w-5 h-5 text-dojo-orange flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Junior and Senior Rank System Manuals for American Judo (hundreds of thousands of copies printed over 40 years)</span>
                </li>
              </ul>
            </div>
            <p>
      ...
      <section className="py-20 bg-gradient-to-b from-bg to-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Leadership Legacy</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="bg-white rounded-xl p-6 shadow-hover border-l-4 border-dojo-navy">
              <h3 className="font-display text-xl font-bold text-dojo-navy mb-4">National Leadership</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>National Chairman, AAU Judo Committee (1961-1964)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Chairman, U.S. Olympic Judo Committee (1964-1968)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>President, U.S. Judo Association (1980-1995)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Editor, "American Judo" (1960-1995)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>President and Head Coach, National Judo Institute (1980-1995)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Founder, United States Martial Arts Association (1995)</span>
                </li>
              </ul>
            </div>

            <div className="bg-white rounded-xl p-6 shadow-hover border-l-4 border-dojo-green">
              <h3 className="font-display text-xl font-bold text-dojo-navy mb-4">International Leadership</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Secretary General, Pan American Judo Union (1964-1967)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Technical Director, Pan American Judo Union (1967-1969)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Consultant, IJF Contest Rules (rewrote rules in 1967)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Referee, World Championships Finals (1965, Brazil)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-dojo-orange font-bold">•</span>
                  <span>Consultative Committee, First Judo Olympics (Tokyo, 1964)</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">Martial Arts Rank & Recognition</h2>

          <div className="bg-gradient-to-br from-dojo-navy/5 to-dojo-orange/5 rounded-2xl p-8 mb-8 border-t-4 border-dojo-navy">
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">Judo: Judan (10th Degree)</h4>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">JuJitsu: Judan (10th Degree)</h4>
                <p className="text-sm text-gray-600">
                  USJA (1st-9th degrees), USMA and Beikoku Mizu Ryu JuJutsu (10th degree, 1997)
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">Beikoku Mizu Ryu JuJitsu: Judan</h4>
                <p className="text-sm text-gray-600">
                  By the Beikoku Mizu Ryu JuJitsu Association
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">Budo Taijutsu: Judan</h4>
                <p className="text-sm text-gray-600">
                  1998 by Dr. Masaaki Hatsumi, 34th Soke of the Togakure Ryu
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">Jun Kin Shin: Soke-10th Degree</h4>
                <p className="text-sm text-gray-600">
                  JuJitsu ryu founded by O-Sensei from his law enforcement and military experience
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-bold text-dojo-navy mb-2">Taiho Jitsu: Judan</h4>
                <p className="text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-br from-dojo-orange/5 to-dojo-red/5 rounded-2xl p-8 border-l-4 border-dojo-orange">
            <h3 className="font-display text-2xl font-bold text-dojo-navy mb-4">Hall of Fame Honors</h3>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>World Martial Arts Hall of Fame – "Heritage Award of Excellence" (April 1997)</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>International Karate & Kickboxing Hall of Fame (April 1997, Cleveland, Ohio)</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>World Headfounders Council – 18th member inducted out of 3,219 applicants (July 1997)</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-dojo-orange flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span>Martial Arts Masters, Pioneers and Legends Hall of Fame – "Legend" category (May 1998)</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-bg to-white">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="font-display text-4xl font-bold text-dojo-navy mb-8">O-Sensei's Teachers</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-dojo-light via-white to-dojo-light/50">
        <div className="mx-auto max-w-4xl px-6">
          <div className="bg-white rounded-2xl shadow-2xl p-12 border-t-4 border-dojo-navy">
            <h2 className="font-display text-4xl font-bold text-dojo-navy mb-6 text-center">Legacy of Excellence</h2>
            ...
            <div className="text-center">
              <a href="/membership" className="inline-flex items-center gap-2 rounded-xl gradient-orange px-8 py-4 text-lg font-semibold text-white shadow-lg hover:shadow-xl transition-all">
                Honor His Legacy - Join WWMAA
