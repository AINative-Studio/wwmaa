    ...
    <div className="min-h-screen bg-gradient-to-b from-bg to-white">
      <div className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <a href="/dashboard/subscription" className="block bg-white rounded-2xl shadow-hover p-8 group">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-xl font-bold text-dojo-navy group-hover:text-dojo-green transition-colors">Subscription</h3>
          ...
          <a href="/dashboard/payments" className="block bg-white rounded-2xl shadow-hover p-8 group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-dojo-orange to-orange-600 flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
