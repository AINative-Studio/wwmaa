        ...
        <div className="grid gap-12 sm:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a href="https://x.com/wwmaa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" aria-label="Follow WWMAA on X (Twitter)">
